...
exec("which firefox", function (error, stdout, stderr) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.trys.push([4, 6, , 7]);
                return [4 /*yield*/, page.locator("xpath=/html/body/ytp-app/div[1]/ytp-page-manager/ytp-watch-flexy/div[5]/div[1]/div/div[1]/div[2]/div/div/ytp-player/div/div/div[5]/button").click()];
            case 5:
                _a.sent();
                return [3 /*break*/, 7];
            case 6:
